class GetFavouriteBusiness {
  ...
  GetFavouriteBusiness.fromJson(Map<String, dynamic> json) {
    sId = json['_id'];
    user = json['user'];
...
class Business {
  ...
  Business.fromJson(Map<String, dynamic> json) {
    ...
    businessOwnerDetail = json['business_owner'] != null
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.businessOwnerDetail != null) {
      data['business_owner'] = this.businessOwnerDetail!.toJson();
    }
